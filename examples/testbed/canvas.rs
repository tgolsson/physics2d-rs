...
pub struct Canvas {
    ...
    view: sfml::system::SfBox<sfml::graphics::View>,
    font: sfml::system::SfBox<sfml::graphics::Font>,
...
impl Canvas {
    ...
    fn draw_circle(
        &mut self,
        _sfml_pos: sfml::system::Vector2f,
        transform: &Transform,
    ...
    pub fn draw_body(&mut self, body: &Body) {
        ...
        match body.shape {
            shapes::Shape::Circle(ref circle) => {
                self.draw_circle(sfml_pos, &body.transform, circle)
            }
            shapes::Shape::Polygon(ref polygon) => {
                self.draw_polygon(sfml_pos, &body.transform, polygon)
            }
        };
    }
    ...
    pub fn draw_point(&mut self, point: Vec2) {
        ...
        for sfml_offset in sfml_offsets {
            ...
            quad.append(&sfml::graphics::Vertex::new(
                sfml_pos - sfml_offset,
                color,
                sfml_offset,
            ));
        }
    ...
    pub fn draw_line(&mut self, a: Vec2, b: Vec2) {
        ...
        let mut line_array =
            sfml::graphics::VertexArray::new(sfml::graphics::PrimitiveType::Lines, 2);

        // TODO: Color parameter?
        let color = sfml::graphics::Color::RED;
        line_array.append(&sfml::graphics::Vertex::new(
            sfml_a,
            color,
            sfml::system::Vector2f::new(0.0, 0.0),
        ));
    ...
    pub fn process_draw_queue(&mut self, window: &mut sfml::graphics::RenderWindow) {
        ...
        let mut text_position =
            sfml::system::Vector2f::new(-width / 2.0 + PADDING, -height / 2.0 + PADDING);
