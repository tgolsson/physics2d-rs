...
impl Circle {
    ...
    fn least_penetration_support_point(
        &self,
...
impl Collide<Polygon> for Circle {
    fn collide(
        ...
        let t = (support - face.a).dot(face_vec) / face_vec.sqr_length();
        ...
        let contact_dist_sqr = rel_contact_point.sqr_length();
